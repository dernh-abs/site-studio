# Site Studio Builder — Agent Instructions (tool-agnostic)
...
`site-studio-builder/references/ai-editing.md` (AI smart editing: selected-component
scope, LLM-driven understanding, clarification, translation, apply/undo correctness).
